...
const allAthletes = {
    ...
    standardFList: [
        ...
        new Biathlete('Franziska Preuss','GER', -1.1, -0.3, -0.5, -1.3, -1.2, 95.2, 89.0, 48.9, 47.3),
        new Biathlete('Lou Jeanmonnot','FRA', -1.8, -2.2, -2.0, -1.6, -0.7, 94.8, 88.6, 51.9, 48.7),
        new Biathlete('Julia Simon','FRA', -0.5, 0.2, 0.4, 0.0, -1.0, 87.6, 81.0, 44.9, 42.0),
        new Biathlete('Elvira Oeberg','SWE', -2.5, -1.9, -2.0, -1.8, -3.4, 84.7, 85.9, 51.1, 46.9),
        new Biathlete('Oceane Michelon','FRA', -0.6, -1.2, -1.3, -1.5, -2.5, 87.6, 83.3, 52.1, 46.4),
        new Biathlete('Jeanne Richard','FRA', 0.1, -0.6, -0.5, -0.9, 0.4, 95.2, 86.2, 53.4, 48.6),
        new Biathlete('Suvi Minkkinen','FIN', 0.8, 1.4, 1.4, 1.9, 1.3, 91.0, 94.0, 49.9, 45.5),
        new Biathlete('Justine Braisaz-Bouchet','FRA', -2.5, -2.7, -2.6, -2.9, -2.2, 74.8, 79.0, 55.4, 46.6),
        new Biathlete('Selina Grotian','GER', 1.5, -0.1, -0.0, -0.5, -0.3, 84.2, 85.3, 50.8, 45.0),
        new Biathlete('Maren Kirkeeide','NOR', 0.1, -0.9, -0.6, -0.8, -2.0, 78.0, 89.5, 55.8, 47.9),
        
        new Biathlete('Lisa Vittozzi', 'ITA', -0.3, -0.9, -1.2, -1.8, -1.4, 93.3, 92.9, 51.3, 47.4),
        new Biathlete('Linn Gestblom','SWE', 0.1, 1.6, 1.1, 1.0, 0.6, 88.9, 88.1, 54.3, 49.0),

        new Biathlete('Lisa Theresa Hauser','AUT', 1.1, 1.1, 0.7, 0.5, 1.5, 90.5, 84.5, 49.7, 46.8),
        new Biathlete('Hanna Oeberg','SWE', -0.6, -0.5, -0.9, -2.0, 0.2, 80.6, 76.0, 48.1, 45.1),
        new Biathlete('Dorothea Wierer','ITA', 1.2, -0.0, 0.1, 0.5, 2.3, 91.9, 76.9, 51.2, 46.1),
        new Biathlete('Karoline Offigstad Knotten','NOR', 1.4, 1.7, 1.4, 1.6, 2.9, 88.8, 80.0, 47.7, 45.8),
        new Biathlete('Milena Todorova','BUL', 1.7, 1.2, 1.6, 0.6, 1.1, 91.0, 79.5, 51.0, 51.6),   
        new Biathlete('Amy Baserga','SUI', 3.3, 3.1, 2.4, 2.5, 1.6, 92.1, 87.9, 50.4, 45.6),
        new Biathlete('Yuliia Dzhima','UKR', 3.1, 4.5, 4.5, 3.7, 2.4, 94.7, 92.1, 51.2, 48.8),
        new Biathlete('Ella Halvarsson','SWE', 0.5, 0.8, 0.9, 0.2, 0.9, 88.0, 83.4, 50.8, 49.2),
        new Biathlete('Lena Haecki-Gross','SUI', 1.6, 1.6, 1.4, 1.8, 2.2, 85.2, 81.0, 47.5, 44.1),
        new Biathlete('Anna Magnusson','SWE', 0.2, 1.0, 1.2, 1.7, 1.8, 90.3, 83.2, 51.5, 48.5),
        new Biathlete('Tereza Vobornikova','CZE', 3.0, 2.1, 1.7, 1.8, 2.9, 91.2, 89.4, 53.0, 48.5),
        new Biathlete('Lotte Lie','BEL', 1.6, 2.0, 2.6, 3.4, 3.3, 93.0, 87.5, 51.4, 47.1),
        new Biathlete('Anamarija Lampic','SLO', -1.8, -3.7, -3.2, -3.5, -4.2, 75.5, 53.5, 53.9, 50.9),
        new Biathlete('Ida Lien','NOR', -0.7, -1.9, -1.9, -1.5, -1.6, 94.1, 67.4, 55.7, 54.6),
        new Biathlete('Vanessa Voigt','GER', 1.4, 1.4, 0.9, 1.8, 1.6, 92.9, 94.3, 57.3, 56.3),
        new Biathlete('Aita Gasparin','SUI', 2.4, 2.3, 1.6, 1.8, 2.6, 89.7, 85.5, 48.2, 48.1),
        new Biathlete('Ingrid Landmark Tandrevold','NOR', -0.9, -0.3, -0.7, -0.2, 0.1, 94.6, 70.0, 55.6, 48.6),
        new Biathlete('Paulina Batovska Fialkova','SVK', -0.3, -0.6, -1.3, -1.4, -0.1, 81.9, 80.0, 52.5, 50.9),
        new Biathlete('Natalia Sidorowicz','POL', 2.1, 2.8, 3.7, 3.0, 2.8, 85.0, 83.3, 49.1, 46.5),
        new Biathlete('Samuela Comola','ITA', 2.0, 1.4, 1.4, 2.1, 3.7, 95.2, 84.8, 54.0, 52.8),
        new Biathlete('Julia Tannheimer','GER', 0.8, 0.2, -0.4, 0.6, 0.2, 82.2, 83.7, 55.2, 48.9),
        new Biathlete('Khrystyna Dmytrenko','UKR', 3.3, 3.9, 4.0, 4.5, 5.1, 90.0, 93.1, 50.1, 48.2),
        new Biathlete('Marketa Davidova','CZE', 0.7, -0.7, -1.3, -2.5, -0.3, 86.7, 86.7, 53.8, 53.1),
        new Biathlete('Paula Botet','FRA', -0.4, -0.1, 1.2, 1.2, 0.9, 81.5, 87.7, 52.8, 48.2),
        new Biathlete('Maya Cloetens','BEL', 1.9, 2.8, 2.9, 4.0, 3.5, 93.1, 89.4, 54.7, 51.2),
        new Biathlete('Jessica Jislova','CZE', 3.1, 2.7, 2.6, 3.6, 2.7, 92.3, 86.5, 53.5, 50.7),
        new Biathlete('Sara Andersson','SWE', 1.1, 1.4, 0.3, 1.2, 1.6, 93.3, 76.7, 51.7, 48.5),
        new Biathlete('Michela Carrara','ITA', 1.4, -0.1, -0.7, -0.4, -0.2, 80.6, 73.1, 52.0, 45.4),
        new Biathlete('Hannah Auchentaller','ITA', 3.1, 2.7, 2.0, 3.4, 2.9, 86.4, 88.0, 52.9, 50.0),
        new Biathlete('Venla Lehtonen','FIN', 1.7, 1.6, 2.1, 2.2, 2.9, 93.8, 78.5, 51.4, 52.5),
        new Biathlete('Anna Gandler','AUT', 0.8, 1.4, 1.8, 2.3, 4.3, 86.7, 78.9, 55.0, 52.5),
        new Biathlete('Ragnhild Femsteinevik','NOR', -0.9, 0.4, 1.9, 1.3, 0.1, 75.6, 84.4, 51.1, 46.1),
        new Biathlete('Lucie Charvatova','CZE', 0.6, 0.8, 0.3, 1.3, 2.4, 75.0, 61.4, 51.2, 51.2),
        new Biathlete('Regina Ermits','EST', 2.3, 3.9, 6.2, 5.5, 5.1, 69.0, 89.0, 54.4, 47.1),
        new Biathlete('Kamila Zuk','POL', 3.1, 2.3, 2.1, 1.0, 2.9, 72.3, 76.2, 56.6, 51.3),
        new Biathlete('Martina Trabucchi','ITA', 3.5, 3.6, 3.8, 4.2, 4.9, 84.0, 90.4, 56.0, 52.8),
        new Biathlete('Olena Horodna','UKR', 3.5, 5.2, 5.3, 6.8, 6.0, 85.7, 81.9, 49.9, 47.7),
        new Biathlete('Deedra Irwin','USA', 1.3, 3.0, 3.1, 3.1, 4.0, 86.7, 82.2, 54.6, 52.8),
        new Biathlete('Sophia Schneider','GER', 1.0, 1.2, 0.9, 1.0, 1.7, 81.0, 78.1, 55.4, 50.0),
        new Biathlete('Polona Klemencic','SLO', 2.8, 2.7, 2.4, 3.3, 3.8, 83.2, 77.6, 50.3, 47.9),
        new Biathlete('Gro Randby','NOR', 1.4, 0.3, -1.3, -0.8, -0.6, 85.0, 60.0, 59.0, 55.0),
        new Biathlete('Susan Kuelm','EST', 3.2, 4.1, 2.9, 5.3, 4.6, 88.6, 73.3, 48.4, 49.0),
        new Biathlete('Alina Stremous','MDA', 2.2, 3.3, 3.0, 4.3, 4.8, 87.3, 90.0, 60.2, 58.4),
        new Biathlete('Joanna Jakiela','POL', 2.7, 2.8, 2.6, 3.9, 5.1, 91.5, 66.9, 54.3, 51.3),
        new Biathlete('Sonja Leinamo','FIN', 2.0, 1.6, 1.0, -0.1, 1.4, 77.6, 67.1, 58.8, 55.0),
        new Biathlete('Lena Repinc','SLO', 2.3, 3.5, 3.0, 4.8, 6.1, 74.3, 81.0, 54.9, 51.3),
        new Biathlete('Anna Andexer','AUT', 1.7, 2.0, 2.2, 3.7, 3.6, 85.0, 73.0, 57.8, 55.1),
        new Biathlete('Tamara Steiner','AUT', 5.1, 6.0, 5.3, 5.2, 6.5, 94.7, 89.5, 51.6, 48.9),
        new Biathlete('Anna Maka','POL', 4.8, 4.4, 5.1, 5.4, 6.1, 88.7, 80.9, 50.9, 49.7),

    ],
    standardMList: [
        new Biathlete('Sturla Holm Laegreid', 'NOR', -0.6, -1.3, -1.8, -1.9, -0.1, 96.2, 90.5, 47.7, 42.7),
        new Biathlete('Eric Perrot','FRA', -0.9, -0.7, -1.2, -2.1, -0.8, 86.7, 92.9, 48.1, 43.1),
        new Biathlete('Sebastian Samuelsson','SWE', -1.4, -1.3, -2.8, -2.4, -1.1, 90.0, 76.7, 47.6, 45.3),
        new Biathlete('Quentin Fillon Maillet','FRA', -1.2, -1.7, -2.3, -2.9, -1.6, 78.1, 86.2, 48.1, 38.9),
        new Biathlete('Tommaso Giacomel','ITA', -1.0, -1.7, -1.9, -1.5, -0.9, 83.3, 81.9, 48.3, 38.6),
        new Biathlete('Emilien Jacquelin','FRA', -1.7, -1.8, -0.8, 1.1, 1.4, 88.0, 78.0, 47.1, 41.8),
        new Biathlete('Vebjoern Soerum','NOR', -0.0, -0.5, -0.1, 0.8, -1.0, 81.6, 81.1, 48.4, 42.7),
        new Biathlete('Jakov Fak','SLO', 1.0, 1.7, 2.0, 1.5, 1.2, 92.9, 89.0, 45.8, 45.7),
        new Biathlete('Martin Uldal','NOR', 0.1, -0.8, -0.0, 1.2, 0.8, 91.0, 77.4, 47.8, 39.1),
        new Biathlete('Fabien Claude','FRA', -0.7, -0.3, -0.7, -0.7, 0.7, 84.8, 78.6, 48.8, 44.5),
        new Biathlete('Endre Stroemsheim','NOR', -0.5, 0.5, 2.1, 1.6, 0.6, 91.1, 84.2, 48.5, 42.4),
        new Biathlete('Philipp Nawrath','GER', 0.5, 0.2, 0.3, 0.4, 0.4, 89.5, 78.0, 48.6, 46.0),
        new Biathlete('Martin Ponsiluoma','SWE', -1.5, -1.7, -2.0, -2.8, -2.5, 71.0, 75.7, 47.7, 43.7),
        new Biathlete('Justus Strelow','GER', 0.8, 1.9, 2.7, 3.2, 3.9, 91.6, 85.8, 43.8, 44.2),
        new Biathlete('Campbell Wright','USA', 0.4, -0.4, -0.3, 0.5, 0.8, 87.0, 85.0, 48.8, 44.0),
        new Biathlete('Niklas Hartweg','SUI', 0.8, 0.6, 1.3, 2.2, 1.7, 87.3, 83.6, 45.9, 43.3),
        new Biathlete('Dmytro Pidruchnyi','UKR', 1.3, 0.9, 2.1, 2.8, 2.4, 85.3, 81.1, 47.9, 45.7),
        new Biathlete('Vitezslav Hornig','CZE', 1.7, 1.1, 1.1, 1.3, 0.3, 85.3, 87.6, 48.8, 44.2),
        new Biathlete('Emilien Claude','FRA', 0.6, 1.6, 1.6, 1.4, 1.3, 84.5, 84.5, 50.3, 45.4),
        new Biathlete('Jesper Nelin','SWE', -0.2, 0.1, 0.2, 0.0, -0.5, 87.9, 77.9, 50.2, 49.2),
        new Biathlete('Philipp Horn','GER', 0.0, 0.4, 1.1, 0.8, -0.6, 83.1, 79.4, 51.1, 45.6),
        new Biathlete('Antonin Guigonnat','FRA', 1.6, 1.6, 2.8, 2.7, 2.4, 90.0, 84.0, 49.9, 41.3),
        new Biathlete('Johannes Dale-Skjevdal','NOR', -0.8, -0.5, -0.9, -0.6, -0.9, 84.4, 75.6, 50.5, 45.4),
        new Biathlete('Danilo Riethmueller','GER', 0.9, 0.5, 0.8, -0.0, 0.3, 77.6, 78.8, 50.9, 48.5),
        new Biathlete('Tero Seppala','FIN', 1.3, 1.2, 0.3, -0.2, 1.2, 88.2, 78.2, 48.1, 45.0),
        new Biathlete('Andrejs Rastorgujevs','LAT', 1.7, 1.8, 1.9, 2.9, 2.8, 96.0, 83.2, 47.9, 45.0),
        new Biathlete('Michal Krcmar','CZE', 1.9, 1.3, 1.2, 1.5, 1.0, 90.0, 78.9, 51.8, 48.2),
        new Biathlete('Vetle Sjaastad Christiansen','NOR', -0.7, -0.5, -0.3, 1.3, 2.5, 89.3, 85.3, 50.5, 46.0),
        new Biathlete('Vitalii Mandzyn','UKR', 2.3, 3.1, 3.2, 2.8, 3.8, 90.0, 84.7, 48.7, 46.2),
        new Biathlete('Johannes Kuehn','GER', 0.4, 0.4, 0.3, 0.8, 0.3, 93.3, 66.1, 50.1, 48.4),
        new Biathlete('Lukas Hofer','ITA', 0.8, 1.1, 1.5, 1.5, 2.5, 83.1, 81.9, 53.9, 45.8),
        new Biathlete('Anton Dudchenko','UKR', 3.5, 4.2, 4.5, 4.5, 5.3, 90.0, 86.7, 50.5, 43.8),
        new Biathlete('Simon Eder','AUT', 3.4, 4.4, 3.4, 4.0, 3.3, 97.3, 80.7, 44.4, 45.9),
        new Biathlete('Joscha Burkhalter','SUI', 3.9, 3.1, 3.5, 3.5, 3.3, 86.3, 81.3, 46.7, 41.8),
        new Biathlete('Thierry Langer','BEL', 2.2, 3.7, 3.3, 3.0, 4.8, 86.0, 86.0, 49.9, 49.9),
        new Biathlete('David Komatz','AUT', 3.8, 5.3, 6.2, 6.7, 4.7, 88.1, 80.7, 49.5, 44.9),
        new Biathlete('Viktor Brandt','SWE', 1.8, 2.7, 1.8, 2.6, 4.2, 85.6, 80.6, 47.0, 42.1),
        new Biathlete('Sebastian Stalder','SUI', 3.4, 4.0, 5.1, 5.2, 6.6, 93.8, 86.2, 49.4, 42.5),
        new Biathlete('Jeremy Finello','SUI', -1.1, -0.4, -0.6, -2.2, 0.2, 86.7, 53.3, 53.1, 49.1),
        new Biathlete('Didier Bionaz','ITA', 1.2, 0.1, 0.3, 1.2, 1.2, 76.8, 73.6, 55.6, 52.2),
        new Biathlete('Jonas Marecek','CZE', 3.5, 3.3, 4.3, 5.5, 7.5, 82.1, 85.7, 52.8, 48.4),
        new Biathlete('Florent Claude','BEL', 3.3, 2.9, 3.3, 3.1, 3.3, 84.4, 90.0, 54.8, 47.1),
        new Biathlete('Vytautas Strolia','LTU', 3.3, 3.2, 3.5, 4.4, 3.5, 85.4, 80.0, 51.3, 45.6),
        new Biathlete('Otto Invenius','FIN', 3.6, 3.6, 4.3, 3.3, 3.8, 81.1, 73.7, 48.8, 44.5),
        new Biathlete('Roman Rees','GER', 2.0, 2.0, 1.9, 1.3, -1.1, 88.6, 88.6, 48.6, 44.4),
        new Biathlete('Miha Dovzan','SLO', 5.7, 6.9, 6.6, 7.0, 6.9, 93.8, 85.4, 45.8, 40.7),
        new Biathlete('Blagoy Todev','BUL', 6.9, 6.9, 4.5, 5.4, 7.4, 88.7, 88.7, 51.3, 44.2),
        new Biathlete('Maxime Germain','USA', 2.5, 2.8, 3.0, 3.6, 4.4, 80.0, 84.4, 49.2, 44.9),
        new Biathlete('Adam Vaclavik','CZE', 1.5, 1.0, 1.4, 1.6, 3.4, 85.0, 60.0, 51.1, 50.6),
        new Biathlete('Rene Zahkna','EST', 4.6, 5.7, 3.1, 2.6, 5.5, 87.5, 88.3, 49.8, 48.0),
        new Biathlete('Dmitrii Shamaev','ROU', 6.1, 6.8, 7.4, 6.9, 6.8, 94.3, 92.4, 50.6, 45.4),
        new Biathlete('Jan Gunka','POL', 4.4, 4.5, 4.5, 4.2, 6.3, 83.1, 82.3, 51.7, 46.9),
        new Biathlete('Daniele Cappellari','ITA', 4.4, 6.4, 7.2, 8.2, 9.9, 92.8, 87.2, 46.9, 43.6),
        new Biathlete('Jake Brown','USA', 2.9, 2.5, 2.2, 0.9, 1.8, 85.9, 81.2, 50.4, 48.9),
        new Biathlete('Felix Leitner','AUT', 5.6, 5.4, 5.3, 5.0, 7.3, 93.7, 87.4, 50.6, 45.6),
        new Biathlete('Adam Runnalls','CAN', 5.1, 4.8, 4.5, 3.3, 4.7, 82.0, 81.0, 46.5, 42.2),
        new Biathlete('Vladimir Iliev','BUL', 2.4, 3.4, 3.3, 2.5, 4.7, 66.7, 83.3, 52.3, 46.9),
        new Biathlete('Emil Nykvist','SWE', 6.1, 5.0, 2.5, 3.7, 7.0, 82.2, 91.1, 55.0, 45.8),

    ],

    subFList: [
        new Biathlete('Anna-Karin Heijdenberg','SWE', 0.1, 0.2, 0.3, 0.9, 2.5, 85.8, 75.8, 51.1, 48.1),
        new Biathlete('Sophie Chauveau','FRA', 0.2, 0.1, 0.0, 0.0, 1.0, 92.9, 68.2, 55.1, 50.1),
        new Biathlete('Johanna Skottheim','SWE', 1.6, 1.8, 1.1, 3.3, 4.1, 86.3, 82.1, 50.1, 45.4),
        new Biathlete('Camille Bened','FRA', 1.2, 2.3, 1.2, 0.7, 1.6, 92.0, 84.0, 43.8, 40.5),
        new Biathlete('Marthe Krakstad Johansen','NOR', 3.2, 3.7, 3.6, 4.9, 6.3, 97.5, 90.0, 50.3, 46.0),
        new Biathlete('Gilonne Guigonnat','FRA', 0.5, 0.6, -0.0, 1.1, 1.1, 86.7, 90.0, 60.5, 52.3),
        new Biathlete('Karoline Erdal','NOR', 1.1, 1.4, 0.1, -0.4, 0.9, 92.0, 72.0, 52.5, 45.0),
        new Biathlete('Juni Arnekleiv','NOR', 0.5, 1.4, 0.8, 2.6, 4.9, 92.7, 72.7, 51.5, 50.9),
        new Biathlete('Anna Weidel','GER', 2.6, 3.5, 3.2, 2.2, 5.5, 86.7, 93.3, 45.8, 42.4),
        ...
        new Biathlete('Elisa Gasparin','SUI', 3.5, 3.7, 3.9, 4.1, 5.5, 90.3, 74.5, 51.2, 48.8),
        ...
        new Biathlete('Emma Lunder','CAN', 5.6, 5.0, 5.1, 6.0, 5.4, 82.1, 87.9, 54.7, 45.5),
    ...
    subMList: [
        new Biathlete('Isak Frey','NOR', 0.9, -0.6, 0.9, 0.3, 1.3, 95.6, 86.7, 45.7, 39.0),
        new Biathlete('Oscar Lombardot','FRA', 2.1, 1.9, 1.8, 0.0, 2.2, 92.0, 92.0, 50.9, 46.7),
        new Biathlete('David Zobel','GER', 1.5, 2.6, 3.4, 5.0, 4.2, 93.0, 74.0, 49.3, 47.3),

        new Biathlete('Johannes Thingnes Boe','NOR', -2.0, -2.4, -2.7, -2.4, -1.4, 86.5, 85.0, 47.7, 41.8),
        new Biathlete('Tarjei Boe','NOR', -0.1, -0.2, -0.1, -0.6, -0.4, 95.0, 83.9, 52.2, 45.1),
